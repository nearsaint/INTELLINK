...
export default {
  data() {
    return {
      ...
      lineOption: {
        ...
        color: ['#D96D32', '#54A0BC', '#74404A', '#484B75', '#C73831', '#436399', '#fff'],
        tooltip: {
          trigger: 'axis',
          ...
          areaStyle: {
            normal:{
              color:{
                ...
                global:false,
                colorStops:[
                  {offset:0,color:'rgba(67,99,153,0.60)'},
                  {offset:1,color:'rgba(60,94,136,0.10)'}
                ]
              }
            }
          },
  ...
  methods: {
    ...
    getProperty: function(id) {
      ...
      that.axios.post('/api/Machine/GetStatisticRTTags', {
        "Inputs": [{
          "GetTagsType": 0,
